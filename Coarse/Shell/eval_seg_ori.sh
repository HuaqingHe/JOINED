...
file_output='./results/paper_results/seg/dataset1/'${train_type}'_'${model_type}'_'${pretrain}'_'${loss}'_'${encoder}'/'

base_path='./dataset1/XXX/'
# base_save_path='./results_seg/XXX/'${train_type}${model_type}'_'${pretrain}'_'${loss}'_'${encoder}'/'
base_save_path='./results_seg/dataset1/XXX/'${train_type}'/'${model_type}'_'${pretrain}'_'${loss}'_'${encoder}'/'
