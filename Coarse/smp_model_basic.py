...
class MyResNestEncoder(ResNestEncoder):
...
for name in my_resnet_encoders:
    my_resnet_encoders[name]["encoder"] = MyResNetEncoder

for name in my_resnest_encoders:
    my_resnest_encoders[name]["encoder"] = MyResNestEncoder

for name in my_vgg_encoders:
    my_vgg_encoders[name]["encoder"] = MyVggEncoder
